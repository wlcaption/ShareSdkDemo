...
namespace cn.sharesdk.unity3d
{
	...
	public class ShareSDK : MonoBehaviour 
	{
		...
		//注:此处区分仅为demo测试而区分，实际使用时可以不区分安卓或iOS
		 #if UNITY_ANDROID
		public string appKey = "1f0b7f85580d2";
		public string appSecret = "de7f08c554d4ea2dae142cc35f9fb16e";
#elif UNITY_IPHONE
		public string appKey = "1f0b7f85580d2";
		public string appSecret = "de7f08c554d4ea2dae142cc35f9fb16e";
#endif
			...
			{	
				...
				foreach (FieldInfo field in fields) 
				{
					if ("type".EndsWith(field.Name)) {
						continue;
					} else if ("Enable".EndsWith(field.Name) || "ShareByAppClient".EndsWith(field.Name) || "BypassApproval".EndsWith(field.Name) || "isNewApi".EndsWith(field.Name)) {
